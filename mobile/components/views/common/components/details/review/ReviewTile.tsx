...
const AttractionTile: React.FC<AttractionTileProps> = ({ opinion, author, loggedInUserId, onPressExtra }) => {
    ...
    const renderLongReview = () => (
        <TouchableOpacity style={reviewTile.reviewTile} onPress={toggleReview}>
            ...
            />
            <View style={{...reviewTile.tileContainer, alignItems: 'flex-end', justifyContent: 'flex-end', marginTop: -10}}>
                ...
                <ScrollView>
                    ...
                    <ScrollView horizontal>
                        {opinion.images.map((image, index) => (
                            <TouchableOpacity style={reviewTile.imageContainer} key={index} onPress={() => toggleImageModal(image)}>
